...
Kullanım:  python backend/veri-toplayici.py
"""
...
REPO_KOKU = os.path.dirname(SCRIPT_DIZINI)  # backend/ -> repo kökü
...
DUNYA_BANKASI = "https://api.worldbank.org/v2/country/TUR/indicator/{kodu}?format=json&per_page=6&date=2018:2026"
